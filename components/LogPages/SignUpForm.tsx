...
export function SignUpForm(props: CredentialsFormProps) {
    ...
    return (
        <div className="inline-block">
                ...
                >
                    <span className="text-2xl font-semibold  text-center">Đăng ký</span>
                    ...
                    <p className="text-red-500 fixed mt-1 text-xxs sm:text-sm">{error}</p>
                    <button type="submit" className="mt-14 relative bg-blue-900 px-4 py-2 active:scale-110 duration-300 rounded-full w-2/3 text-white text-sm md:text-xl">Đăng ký</button>
                </form> 
                ...
                >
                    <span className="mt-10 text-2xl font-semibold  text-center">Xác thực OTP</span>
                    <span className="mt-5 text-lg font-semibold  text-center animate-bounce">Mình đang gửi <span className="text-red-600">mail</span> cho bạn...</span>
                    ...
                    <p className="text-red-500 fixed mt-1 text-xxs sm:text-sm">{error}</p>
                    <button onClick={()=> handleSubmitOtp()} className="mt-10 relative bg-blue-900 px-4 py-2 active:scale-110 duration-300 rounded-full w-2/3 text-white text-sm md:text-xl">Xác nhận</button>
                    <button onClick={()=>{setShow(!show)}} className="mt-5 relative bg-blue-900 px-4 py-2 active:scale-110 duration-300 rounded-full w-2/3 text-white text-sm md:text-xl">Quay lại</button>
                </div>
        </div>
    );
}