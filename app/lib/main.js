...
exports.FlashCardOperation =
	...
	exports.QuizOperation =
	exports.AccountOperation =
	exports.AuthOperation =
		void 0;
				...
				switch (_c.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							axios_1.default.post(
								"".concat(this.baseUrl, "/otp/verify"),
								payload,
								{
									withCredentials: true,
									validateStatus: function (status) {
							...
							2 /*return*/,
							{
								...
								request:
									error_3 === null || error_3 === void 0
										? void 0
										: error_3.request,
								status: error_3.response
									? error_3.response.status
									: null,
							},
						];
					case 3:
							...
							2 /*return*/,
							{
								...
								request:
									error_4 === null || error_4 === void 0
										? void 0
										: error_4.request,
								status: error_4.response
									? error_4.response.status
									: null,
							},
						];
					case 3:
				...
				switch (_c.label) {
					...
					case 2:
						...
						console.log(
							...
							(_a =
								error_5 === null || error_5 === void 0
									? void 0
									: error_5.response) === null ||
								_a === void 0
								? void 0
								: _a.data
						);
							...
							2 /*return*/,
							{
								...
								request:
									error_5 === null || error_5 === void 0
										? void 0
										: error_5.request,
								status: error_5.response
									? error_5.response.status
									: null,
							},
						];
					case 3:
				...
				switch (_c.label) {
					case 0:
						...
						return [
							...
							axios_1.default.post(
								""
									.concat(this.baseUrl, "/avatar/update/")
									.concat(id),
								formData,
								{
									withCredentials: true,
					...
					case 2:
						...
						console.log(
							...
							(_a =
								error_6 === null || error_6 === void 0
									? void 0
									: error_6.response) === null ||
								_a === void 0
								? void 0
								: _a.data
						);
							...
							2 /*return*/,
							{
								...
								request:
									error_6 === null || error_6 === void 0
										? void 0
										: error_6.request,
								status: error_6.response
									? error_6.response.status
									: null,
							},
						];
					case 3:
				...
				switch (_c.label) {
					case 0:
						...
						return [
							...
							axios_1.default.get(
								""
									.concat(this.baseUrl, "/avatar/get/")
									.concat(id),
								{
									withCredentials: true,
									validateStatus: function (status) {
					...
					case 2:
						...
						console.log(
							...
							(_a =
								error_7 === null || error_7 === void 0
									? void 0
									: error_7.response) === null ||
								_a === void 0
								? void 0
								: _a.data
						);
							...
							2 /*return*/,
							{
								...
								request:
									error_7 === null || error_7 === void 0
										? void 0
										: error_7.request,
								status: error_7.response
									? error_7.response.status
									: null,
							},
						];
					case 3:
							...
							2 /*return*/,
							{
								...
								request:
									error_23 === null || error_23 === void 0
										? void 0
										: error_23.request,
								status: error_23.response
									? error_23.response.status
									: null,
							},
						];
					case 3:
				...
				switch (_c.label) {
					...
					case 2:
						...
						console.log(
							"Error searching accounts: ",
							(_a =
								error_24 === null || error_24 === void 0
									? void 0
									: error_24.response) === null ||
								_a === void 0
								? void 0
								: _a.data
						);
							...
							2 /*return*/,
							{
								...
								request:
									error_24 === null || error_24 === void 0
										? void 0
										: error_24.request,
								status: error_24.response
									? error_24.response.status
									: null,
							},
						];
					case 3:
							...
							2 /*return*/,
							{
								...
								request:
									error_25 === null || error_25 === void 0
										? void 0
										: error_25.request,
								status: error_25.response
									? error_25.response.status
									: null,
							},
						];
					case 3:
				...
				switch (_c.label) {
					...
					case 2:
						...
						console.log(
							"Error updating account: ",
							(_a =
								error_26 === null || error_26 === void 0
									? void 0
									: error_26.response) === null ||
								_a === void 0
								? void 0
								: _a.data
						);
							...
							2 /*return*/,
							{
								...
								request:
									error_26 === null || error_26 === void 0
										? void 0
										: error_26.request,
								status: error_26.response
									? error_26.response.status
									: null,
							},
						];
					case 3:
							...
							2 /*return*/,
							{
								...
								request:
									error_27 === null || error_27 === void 0
										? void 0
										: error_27.request,
								status: error_27.response
									? error_27.response.status
									: null,
							},
						];
					case 3:
