...
import { CreateFlashCard, CreateFTag, CreateFullPracticeFromTest, CreateFullQuiz, CreateFullTest, CreateTag, CreateTestFromQuizIds, FetchingType, GetRecord, InitRecord, LoginPayload, SearchPayload, SignUpPayload, Skill, UpdateAccountPayload, UpdateAvatarPayload, UpdateFlashCard, UpdateFTag, UpdateFullQuiz, UpdateFullTest, UpdateQuiz, UpdateRecord, UpdateRecordConfig, UpdateTag, VerifyOtpPayload } from "./interfaces";
