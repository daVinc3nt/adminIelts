  ...
  return (
    ...
    >
      <motion.div
        ...
        rounded-xl p-5 overflow-y-auto ${
      ...
      >
        <div className="relative items-center justify-center flex-col flex h-10 w-full border-b-2 border-[#545e7b]">
          <div className="font-bold text-lg sm:text-2xl pb-2 text-black w-3/5 text-center">
            {/* <FormattedMessage id="order.bulk"/> */} Thêm hàng loạt
          </div>
          <Button
        ...
        <div className="text-center py-5">
          {/* <FormattedMessage id="order.chooseexcel"/> */} Chọn file excel
        </div>
        ...
        <div className="text-center py-5">
        {/* <FormattedMessage id="order.downloadsample" /> */} Tải mẫu thử
        </div>
        <a 
        ...
        >
          <span className="hidden xs:block">
            {/* <FormattedMessage id="order.add" /> */} Thêm
          </span>
        </Button>
      </motion.div>
    </motion.div>
