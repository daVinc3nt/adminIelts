...
export default function TestList({
	...
	return (
		<div className="flex flex-col flex-1 items-center bg-white border rounded-lg shadow-md overflow-hidden py-2">
			<div className="grid w-full grid-cols-8 gap-4 mb-2 min-h-10">
			...
			<div className="flex flex-col flex-grow w-full overflow-auto">
				{testInfor.map((test, index) => (
					<div
						...
						className={`grid w-full grid-cols-8 gap-4 py-2 h-fit  ${currentTest == index ? "bg-red-200" : "hover:bg-red-100"}`}>
